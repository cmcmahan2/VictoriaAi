  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <p className="text-[#888] text-center mb-8 text-sm">Sign in to your Tracklist account</p>
        ...
        <p className="text-center text-sm text-[#888] mt-6">
          ...
          <Link href="/register" className="text-[#E8B84B] hover:underline">Sign up</Link>
        </p>
      </div>
    </div>
  );
