...
DECISION_LEAD_SECONDS = 60     # decide this many seconds before the 5m window closes
...
KELLY_FRACTION = 0.25          # fraction of full-Kelly stake to actually deploy
HEDGE_FRACTION = 0.35          # HEDGE stake as a fraction of the FAV stake
MAX_POSITION_FRAC = 0.10       # cap any single FAV stake at 10% of bankroll
...
MAX_SIGNAL_WINPROB = 0.70

# --------------------------------------------------------------------------- #
# Drawdown control
# --------------------------------------------------------------------------- #
MAX_DRAWDOWN = 0.35            # halt all trading once bankroll is 35% below peak
DERISK_DRAWDOWN = 0.20         # start scaling size down past 20% drawdown
